...
const tabOptions = [
  { label: "Seminar Only", isActiveStage: true },
  { label: "Author / Conference Presenter", isActiveStage: true },
];
  ...
  <ConfigProvider :use-id="useIdFunction" v-else>
    <div class="h-full max-h-[calc(100dvh-53px-3rem)] overflow-y-auto px-4 py-2 sm:px-6 sm:py-4">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
        <h1 class="text-lg sm:text-xl font-bold">My Conference</h1>
        <div class="flex flex-wrap items-center gap-2">
          <SubmissionDialogCreateAbstract />
          <button
